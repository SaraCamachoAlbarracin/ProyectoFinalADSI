                     ...
                     <div class="input-field col s4">
                        ...
                        <label>Estado</label>
                          ...
                          <div class="input-field col s4">
                            ...
                            <option value="<%=a.getUsuario()%>"><%=a.getUsuario()%></option>
                            <% for(Usuario Q:U){%>
                        ...
                        <label>Usuario</label>
                         ...
                         <div class="input-field col s4">
                             <select name="auto" required>
                                   <option value="<%=a.getAutomovil()%>"><%=a.getAutomovil()%></option>
                                     <% for(Automovil Q:A){%>
