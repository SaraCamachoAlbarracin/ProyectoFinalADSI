...
<%
    Modelos.Compra a = (Modelos.Compra)request.getSession().getAttribute("nombre");
...
<head>
  ...
  <title>Modificar Compra | Trading Cars</title>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">Compra</h4>
                <div class="row">
                    <form class="col s12" method="post" action="ProCompra/update">
                  <input value="<%=a.getIdCompra()%>" name="Id" style="visibility: hidden;">
                        <div class="input-field col s6">
                             <input id="Fecha" type="date" name="Fecha" value="<%=a.getFechaEntrega()%>" required readonly="readonly">
                     ...
                     <div class="input-field col s4">
                        ...
                        <label>Estado</label>
                         ...
                         <div class="input-field col s4">
                             <select name="Automovil" required>
