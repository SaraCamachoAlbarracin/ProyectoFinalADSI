...
<head>
  ...
  <title>Listado Tiempo  | Trading Cars</title>
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
         ...
         Query rs = Ss.createQuery("from Tiempo");
     
           List<Modelos.Tiempo> op = rs.list();
           for(Modelos.Tiempo ñ : op){
         
               
       %>
                    <tbody>
                      <tr>
                      <td>  <%=ñ.getFechaActual()%></td>
                      ...
                      <td> 
                               ...
                               <a href="ProTiempo/read/<%=ñ.getIdTiempo()%>" class="btn waves-effect waves-light"><i class="mdi-action-autorenew"></i></a>
                               <a href="ProTiempo/delete/<%=ñ.getIdTiempo()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="mdi-communication-comment left"></i></a>
