      ...
      <section id="content">
       ...
       %>
                    <tbody>
                      ...
                      <td>   <%=ñ.getDescuento()%></td>
                      <td>   <%=ñ.getTotal()%></td>
                      <td>  <%=ñ.getEstado()%></td>
                      <td>   <%=ñ.getAutomovil().getPlaca()%></td>
                      <td> 
                           
                               <a href="ProCompra/read/<%=ñ.getIdCompra()%>" class="btn waves-effect waves-light"><i class="mdi-action-autorenew"></i></a>
                               <a href="ProCompra/delete/<%=ñ.getIdCompra()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="mdi-communication-comment left"></i></a>
