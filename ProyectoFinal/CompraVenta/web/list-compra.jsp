...
<head>
  ...
  <title>Listado Compras  | Trading Cars</title>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #28B463" > Historial de Compras </h4>
              <br>
              <div class="row">
         ...
         Query rs = Ss.createQuery("from Compra");
     
           List<Modelos.Compra> op = rs.list();
           for(Modelos.Compra ñ : op){
       ...
       %>
                    <tbody>
                      ...
                      <td>  <label>$</label> <%=ñ.getTotal()%></td>
                      <td>  <%=ñ.getEstado()%></td>
                      <td>   <%=ñ.getAutomovil().getPlaca()%></td>
                      <td> 
                           
  <a href="ProCompra/read/<%=ñ.getIdCompra()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
  <a href="ProCompra/delete/<%=ñ.getIdCompra()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="material-icons">delete</i></a>
