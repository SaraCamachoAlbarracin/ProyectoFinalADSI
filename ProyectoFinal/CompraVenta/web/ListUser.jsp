...
<head>
  ...
  <title>Listado Usuarios  | Trading Cars</title>
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #28B463" > Usuarios Registrados </h4>
              <br>
              <div class="row">
         ...
         Query rs = Ss.createQuery("from Usuario");
     
           List<Modelos.Usuario> op = rs.list();
           for(Modelos.Usuario ñ : op){
       ...
       %>
                    <tbody>
                      ...
                      <td>   <%=ñ.getGenero()%></td>
                      <td>   <%=ñ.getNlicencia()%></td>
                      <td>   <%=ñ.getEstado()%></td>
                      <td> 
                           
                               <a href="ProUsuario/read/<%=ñ.getIdCliente()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
                               <a href="ProUsuario/delete/<%=ñ.getIdCliente()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="material-icons">delete</i></a>
