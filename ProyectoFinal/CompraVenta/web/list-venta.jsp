...
<head>
  ...
  <title>Listado Ventas | Trading Cars</title>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #28B463" > Historial de Ventas </h4>
              <br>
              <div class="row">
         ...
         Query rs = Ss.createQuery("from Venta");
     
           List<Modelos.Venta> op = rs.list();
           for(Modelos.Venta ñ : op){
         
               
       %>
                    <tbody>
                      <tr>
                      <td>  <%=ñ.getFechaEntrega()%></td>
                      <td>   <label>$</label><%
                      Double d = ñ.getTotal();
                      out.print(String.valueOf(d.longValue()));
                      %></td>
                      <td>  <%=ñ.getDescripcion()%></td>
                     <td>   <%=ñ.getUsuario().getNombres()%></td>
                      <td>   <%=ñ.getAutomovil().getPlaca()%></td>
                     <td>   <%=ñ.getTrabajador().getNombres()%></td>
                      <td> 
                           
       <!--<a href="ProVenta/read/<%=ñ.getIdVenta()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>-->
         <a href="ProVenta/delete/<%=ñ.getIdVenta()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="material-icons">delete</i></a>
