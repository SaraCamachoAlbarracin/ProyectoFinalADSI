...
<head>
  ...
  <title> Carros Vendidos  | Trading Cars</title>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
                <h3 class="header" style="color: #28B463"> Carros Vendidos </h3>
                <br>
              <div class="row">
                  ...
                  <%
                    ...
                    Query rs = Ss.createQuery("SELECT C from Venta C  INNER JOIN C.automovil");

                      List<Modelos.Venta> op = rs.list();
                      for(Modelos.Venta L : op){
                  %>
                    <tbody>
                      <tr>
                        <td>  <%=L.getAutomovil().getIdAutomovil()%></td>
                      <td>  <%=L.getAutomovil().getPlaca()%></td>
                      <td>  <%=L.getAutomovil().getColor()%></td>
                      <td>  <%=L.getAutomovil().getModelo()%></td>
                     <td>   <%=L.getUsuario().getNombres()%></td>
                      <td>   <%=L.getTrabajador().getNombres()%></td>
