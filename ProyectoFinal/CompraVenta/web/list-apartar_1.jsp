    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #EAB425" >Autos Apartados</h4>
              <br>
              <div class="row">
                  ...
                  <table class="table" id="example" >
                    ...
                    <%
              Session ss = Modelos.HibernateUtil.getSessionFactory().openSession();
              Query ap = ss.createQuery("from Apartar");
     
                List<Modelos.Apartar> aa = ap.list();
                for(Modelos.Apartar l : aa){
       ...
       %>
                  ...
                  <a href="ProApartar/readt/<%=l.getIdApartar()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
