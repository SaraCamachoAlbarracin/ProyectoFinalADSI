...
<%
    Modelos.Apartar a = (Modelos.Apartar)request.getSession().getAttribute("nombre");
...
<head>
  ...
  <title>Modificar Apartar | Trading Cars</title>
      ...
      <section id="content">
          ...
          <div class="row">
            <div class="col s12 m12 l12">
                <form class="col s12" method="post" action="ProApartar/updatet">
              <div class="card-panel">
                <h4 style="color: #28B463"> Modificar Apartado</h4>
                <div class="row">
                         <input value="<%=a.getIdApartar()%>" name="Id" style="visibility: hidden;"/>
                         
                        <div class="input-field col s4">
                            <input id="Fecha" type="date" name="Fecha" value="<%=a.getFechaActual()%>"  readonly="readonly" required />
