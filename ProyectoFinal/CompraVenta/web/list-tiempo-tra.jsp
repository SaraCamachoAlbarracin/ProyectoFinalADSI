      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #EAB425" >Autos Fuera De Tiempo </h4>
              <br>
              <div class="row">
                  ...
                  <thead style="background: #EAB425 ">
                    ...
                    <%
           Session ss = Modelos.HibernateUtil.getSessionFactory().openSession();
         Query as = ss.createQuery("from Tiempo");
     
           List<Modelos.Tiempo> ti = as.list();
           for(Modelos.Tiempo ñ : ti){
       ...
       %>
                    <tbody>
                      ...
                      <td>
                          <a href="ProTiempo/deletet/<%=ñ.getIdTiempo()%>" ><img src="images/eliminar.png"> </a>
                      </td>
