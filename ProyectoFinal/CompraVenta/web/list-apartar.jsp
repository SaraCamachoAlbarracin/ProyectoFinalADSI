...
<head>
  ...
  <title>Listado Apartar | Trading Cars</title>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #28B463" >Autos y Motos Apartados </h4>
              <br>
              <div class="row">
              ...
              Query rs = Ss.createQuery("from Apartar");
     
                List<Modelos.Apartar> op = rs.list();
                for(Modelos.Apartar l : op){
         
       %>
                    <tbody>
                      <tr>
                      <td>  <%=l.getFechaActual()%></td>
                      <td>  <%=l.getEstado()%></td>
                     <td>   <%=l.getUsuario().getNombres()%></td>
                      <td>   <%=l.getAutomovil().getPlaca()%></td>
                      <td> 
                           
                  <a href="ProApartar/read/<%=l.getIdApartar()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
