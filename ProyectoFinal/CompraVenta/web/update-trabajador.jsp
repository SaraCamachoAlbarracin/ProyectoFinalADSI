<%-- 
    Document   : update-trabajador
    Created on : 30-ago-2017, 18:57:02
    Author     : User
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<%
    Modelos.Trabajador t = (Modelos.Trabajador)request.getSession().getAttribute("nombre");
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463"> ModificarTrabajador</h4>
                <div class="row">
                    <form class="col s12" method="post" action="ProTrabajador/update">
                        <input value="<%=t.getIdTrabajador()%>" name="Id" style="visibility: hidden;">
                   <div class="row">
                    ...
                    <div class="row">
                      <div class="input-field col s4">
                          <input id="first_name" type="text" name="Nombres" value="<%=t.getNombres()%>"  required>
                        <label for="first_name">Nombres</label>
                      </div>
                    
                      <div class="input-field col s4">
                        <input id="last_name" type="text" name="Apellidos" value="<%=t.getApellidos()%>"  required>
                    ...
                    <div class="row">
                      <div class="input-field col s4">
                          ...
                          <option value="<%=t.getTdocumento()%>"><%=t.getTdocumento()%></option>
                       ...
                       <div class="input-field col s4">
                           <input id="first_name" type="text" name="Documento" value="<%=t.getDocumento()%>"  required>
                      ...
                      <div class="row">
                      <div class="input-field col s4">
                        <input id="first_name" type="text" name="Celular" value="<%=t.getCelular()%>"  required>
                        <label for="first_name">Celular</label>
                      </div>
                    
                      <div class="input-field col s4">
                          <input id="last_name" type="text" name="Ciudad" value="<%=t.getCiudad()%>"  required>
             ...
             <div class="input-field col s4">
                        <input id="first_name" type="text" name="Direccion" value="<%=t.getDireccion()%>"  required>
                        <label for="first_name">Direccion</label>
                      </div>                     
                     
                      <div class="input-field col s4">
                          <select name="Genero" required>
                          <option value="<%=t.getGenero()%>"><%=t.getGenero()%></option>
                         <option>Seleccione Otro</option>
                        ...
                        <label>Genero</label>
                                        ...
                                        <div class="row">
                      <div class="input-field col s4">
                          <input id="password6" type="password" name="Contrasena" value="<%=t.getContrasena()%>"  required>
                     ...
                     <div class="input-field col s4">
                         <select name="Estado" required>
                          <option value="<%=t.getEstado()%>"><%=t.getEstado()%></option>
                         <option>Seleccione Otro</option>
