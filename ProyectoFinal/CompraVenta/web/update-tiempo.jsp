...
<%
    Modelos.Tiempo a = (Modelos.Tiempo)request.getSession().getAttribute("nombre");
%>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <title>Modificar Tiempo | Trading Cars</title>
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <!--breadcrumbs end-->
          ...
          <div class="row">
            <div class="col s12 m12 l12">
                  <form class="col s12" method="post" action="ProTiempo/update">
              <div class="card-panel">
                <h4 style="color: #28B463">ModificarTiempo</h4>
                <div class="row">
                  
                         <input value="<%=a.getIdTiempo()%>" name="Id" style="visibility: hidden;">
                        <div class="input-field col s4">
                             <input id="Fecha" type="date" name="Fecha" value="<%=a.getFechaActual()%>"  required readonly="readonly">
