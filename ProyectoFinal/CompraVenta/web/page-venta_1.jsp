            ...
            <div class="col s12 m12 l12">
              <div class="card-panel">
               <h4 style="color: #28B463" > Venta </h4>
                <br>
                <div class="row">
                    <form class="formValidate" id="formValidate" class="col s12" method="post" action="ProVenta/createV">
                     ...
                     <div class="input-field col s4">
                        ...
                        <div class="input-field col s4">
                            <input  type="text" name="Total" id="Total" style="background: #FB9400; color: black" />
                      </div>
                            <input type="text" name="Trabajador" value="<%=us.getIdTrabajador()%>" style="visibility: hidden;"/>
                        <%
                           } 
                          %>
                      <div class="row">
