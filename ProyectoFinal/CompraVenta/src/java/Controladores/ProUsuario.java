    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      if(Params.length>=3){
          switch(Params[3])
          {
              ...
              case "createt":
              RegUsuarioT(request,response);
              break;
                  
               case "createa":
               RegUsuarioA(request,response);
               break;  
     ...
     private void RegistrarUsuario(HttpServletRequest request, HttpServletResponse response) 
      throws ServletException, IOException {
        ...
        */
          ...
          response.sendRedirect("../page-login.html?Result=true");
          
          
    }
     
     private void RegUsuarioT(HttpServletRequest request, HttpServletResponse response) 
      throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        ...
        */
          ...
          response.sendRedirect("../page-user-tra.jsp?Result=true");
    }
     
     
     private void RegUsuarioA(HttpServletRequest request, HttpServletResponse response) 
      throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        ...
        */
          ...
          response.sendRedirect("../page-user.jsp?Result=true");
    }
...
private void UpUsers(HttpServletRequest request, HttpServletResponse response) 
        throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        ...
        Usuario US =(Modelos.Usuario)sesion.get(Modelos.Usuario.class,id);
         ...
         response.sendRedirect("../Update_Users.jsp?Result=true");
}
