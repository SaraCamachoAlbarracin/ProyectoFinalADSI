...
<%
    Modelos.Automovil a = (Modelos.Automovil)request.getSession().getAttribute("nombre");
...
<head>
  ...
  <title>Modificar Automovil | Trading Cars</title>
...
<body>
   <%@page import="Modelos.Usuario"%>
    <%
        ...
        Criteria q=ss.createCriteria(Usuario.class);
        List<Usuario> A =q.list();
    %>
  <!-- Start Page Loading -->
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463">Actualizar Automovil</h4>
                <div class="row">
                    <form class="col s12" method="post" action="ProAutomovil/update">
                         <input value="<%=a.getIdAutomovil()%>" name="Id" style="visibility: hidden;">
                   <div class="row">
                       
                       
                    <div class="row">
                         <div class="input-field col s4">
                             <input id="Fecha" type="date" name="Fecha" value="<%=a.getFechaEntrada()%>"  required>
                        <label for="Fecha"></label>
                      </div>
                        
                      <div class="input-field col s4">
                          <select name="Tipo" required readonly="readonly">
                      ...
                      <div class="input-field col s4">
                          <input id="Placa" type="text" name="Placa" value="<%=a.getPlaca()%>"  required readonly="readonly">
                        <label for="Placa">Placa</label>
                      </div>
                    
                      <div class="input-field col s4">
                        <input id="Color" type="text" name="Color" value="<%=a.getColor()%>"  required >
                        <label for="Color">Color</label>
                      </div>
                        
                        <div class="input-field col s4">
                        <input id="Modelo" type="text" name="Modelo" value="<%=a.getModelo()%>"  required readonly="readonly">
                        <label for="Modelo">Modelo</label>
                      </div>
                    </div>
                        
                        <div class="input-field col s4">
                        <input id="Marca" type="text" name="Marca" value="<%=a.getMarca()%>"  required readonly="readonly">
                        <label for="Marca">Marca</label>
                      </div>
                  
                
                       <div class="input-field col s4">
                        <input id="Kilometraje" type="text" name="Kilometraje" value="<%=a.getKilometraje()%>"  required readonly="readonly">
                        <label for="Kilometraje">Kilometraje</label>
                      </div>
              
                
                    <div class="input-field col s4">
                        <input id="Ciudad" type="text" name="Ciudad" value="<%=a.getCiudad()%>"  required>
                        <label for="Ciudad">Ciudad</label>
                      </div>
                  
              
                        <div class="input-field col s4">
                                  <input id="Descripcion" type="text" name="Descripcion" value="<%=a.getDescripcion()%>"  required>
                         ...
                         <div class="input-field col s4">
                            <span>Seguro</span><br>
                                   ...
                                   <input type="file" name="Seguro"  class="btn waves-effect waves-light "  style="background: #f39c54;"  required><br/>
                         </div>
                              
     <div class="input-field col s4">
                            <span>Soat</span><br>
                             <input type="file" name="Soat"  class="btn waves-effect waves-light "  style="background: #f39c54;"  required><br/>
                            </div>
                           
  
                    <div class="row">
                      <div class="input-field col s4">
                          <select name="Impuestos" required>
                            <option value="<%=a.getImpuestos()%>"><%=a.getImpuestos()%></option>
                       ...
                       <div class="input-field col s4">
                        <input id="Valor" type="text" name="Valor" value="<%=a.getValor()%>"  required>
                      ...
                      <div class="input-field col s4">      
                            <span>Foto</span><br>
                            <input type="file" name="Foto"  class="btn waves-effect waves-light "  style="background: #f39c54;"  required><br/><br>
                            </div>
                      </div> 
                        
                     <div class="input-field col s4">
                         <select name="Estado" required>
                            <option value="<%=a.getEstado()%>"><%=a.getEstado()%></option>
                     ...
                     <div class="input-field col s4">
                         <select name="Usuario" required>
                           <option value="<%=a.getUsuario().getIdCliente()%>"><%=a.getUsuario()%></option>
                           <option>Seleccione Otro</option>
                          <% for(Usuario Q:A){%>
                          <option value="<%=Q.getIdCliente()%>"><%=Q.getNombres()%>-<%=Q.getApellidos()%></option>
                          <%
                           }
                          %>
                        </select>
