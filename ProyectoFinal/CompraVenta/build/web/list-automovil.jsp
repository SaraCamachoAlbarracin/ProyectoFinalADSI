        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
                <div class="card-panel"><h4 style="color: #28B463" > Autos y Motos Registrados</h4>
              <br>
              <div class="row">
       ...
       %>
                    <tbody>
                      ...
                      <td> 
                               ...
                               <a href="ProAutomovil/delete/<%=ñ.getIdAutomovil()%>" class="btn waves-effect waves-light"><i class="material-icons">delete</i></a>
