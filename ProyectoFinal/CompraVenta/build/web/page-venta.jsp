...
<head>
  ...
  <title>Venta | Trading Cars</title>
...
<body> 
    ...
    <%
        ...
        Query q = ss.createQuery("from Automovil e where e.estado='Activo'");
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                ...
                <ol class="breadcrumb">
                    <li><a href="page-menu.html">Inicio</a>
                  </li>
                  <li><a href="#">Forms</a>
                  </li>
                </ol>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463" > Venta </h4>
              <br>
                <div class="row">
                    <form class="formValidate" id="formValidate" class="col s12" method="post" action="ProVenta/create">
                     ...
                     <div class="input-field col s4">
                        ...
                        <div class="input-field col s4">
                            <input id="Total" type="text" name="Total" style="background: #FB9400; color: black" >
                      </div>
                     
                        
                        <div class="input-field col s4">
                            <select name="Trabajador" id="Tipo" required>
                          <option value="" disabled selected>Seleccione</option>
                          <% for(Trabajador Q:T){%>
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <button id="formValidate" class="btn waves-effect waves-light " type="submit" name="action">Registar
