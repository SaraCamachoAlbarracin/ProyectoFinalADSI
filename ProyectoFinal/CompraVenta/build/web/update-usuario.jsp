<%-- 
    Document   : update-usuario
    Created on : 30-ago-2017, 18:39:17
    Author     : User
--%>
...
<head>
  ...
  <title>Modificar Usuario | Trading Cars</title>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463">Actualizar Usuario</h4>
                <div class="row">
                    <form class="col s12" method="post" action="ProUsuario/update">
                  
                       
                        <input value="<%=ñ.getIdCliente()%>" name="Id">
                    <div class="row">
                        
                          <div class="input-field col s4">
                              <input id="Placa" type="text" name="Nombres" value="<%=ñ.getNombres()%>" required>
                        <label for="Placa">Nombres</label>
                      </div>
                        
                        <div class="input-field col s4">
                        <input id="Placa" type="text" name="Apellidos" value="<%=ñ.getApellidos()%>" required>
                        <label for="Placa">Apellidos</label>
                      </div>  
                    </div>
                         <div class="row">
                      <div class="input-field col s4">
                          <select name="TipoD" required>
                          <option value="<%=ñ.getTdocumento()%>"><%=ñ.getTdocumento()%></option>
                      ...
                      <div class="input-field col s4">
                        <input id="Valor" type="text" name="Documento" value="<%=ñ.getDocumento()%>" required>
                        <label for="Valor">Documento</label>
                      </div>   
                      </div>
                      ...
                      <div class="row">
                          ...
                          <div class="input-field col s4">
                              <input id="Placa" type="text" name="Celular" value="<%=ñ.getCelular()%>"  required>
                        <label for="Placa">Celular</label>
                      </div>
                        
                        <div class="input-field col s4">
                        <input id="Placa" type="text" name="Ciudad" value="<%=ñ.getCiudad()%>"  required>
                        <label for="Placa">Ciudad</label>
                      </div>  
                    </div>
                      ...
                      <div class="row">
                          <div class="input-field col s4">
                        <input id="Valor" type="text" name="Direccion" value="<%=ñ.getDireccion()%>"  required>
                        <label for="Valor">Dirección</label>
                      </div>   
                      <div class="input-field col s4">
                          <select name="Genero" required>
                          <option value="<%=ñ.getGenero()%>"><%=ñ.getGenero()%></option>
                          <option>Seleccione Otro</option>
                     ...
                     <div class="row">   
                  <div class="input-field col s4">
                      <input id="Contraseña" type="password" name="Contra" value="<%=ñ.getContrasena()%>"  required>
                    ...
                    <div class="row">
                          <div class="input-field col s4">
                        <input id="Valor" type="text" name="NLicencia" value="<%=ñ.getNlicencia()%>"  required>
                        <label for="Valor">Numero Licencia</label>
                      </div>   
                        
                      <div class="input-field col s4">
                          <select name="Estado" required>
                          <option value="<%=ñ.getEstado()%>"><%=ñ.getEstado()%></option>
                          <option>Seleccione Otro</option>
