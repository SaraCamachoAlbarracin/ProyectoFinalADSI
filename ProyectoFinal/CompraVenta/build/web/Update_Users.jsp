          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463" >Actualizar Datos</h4>
                <div class="row">
                    <form class="col s12" method="post" action="ProUsuario/updates">
                  
                       
                        <input value="<%=us.getIdCliente()%>" name="Id"style="visibility: hidden;" />
                    <div class="row">
                        
                          <div class="input-field col s4">
                              <input id="Placa" type="text" name="Nombres" value="<%=us.getNombres()%>" required>
                        <label for="Placa">Nombres</label>
                      </div>
                        
                        <div class="input-field col s4">
                        <input id="Placa" type="text" name="Apellidos" value="<%=us.getApellidos()%>" required>
                      ...
                      <div class="input-field col s4">
                        <input id="Valor" type="text" name="Documento" value="<%=us.getDocumento()%>" required>
                      ...
                      <div class="row">
                          ...
                          <div class="input-field col s4">
                              <input id="Placa" type="text" name="Celular" value="<%=us.getCelular()%>"  required>
                        <label for="Placa">Celular</label>
                      </div>
                        
                        <div class="input-field col s4">
                        <input id="Placa" type="text" name="Ciudad" value="<%=us.getCiudad()%>"  required>
                      ...
                      <div class="row">
                          <div class="input-field col s4">
                        <input id="Valor" type="text" name="Direccion" value="<%=us.getDireccion()%>"  required>
                     ...
                     <div class="row">   
                  <div class="input-field col s4">
                      <input id="Contraseña" type="password" name="Contra" value="<%=us.getContrasena()%>"  required>
                    ...
                    <div class="row">
                          <div class="input-field col s4">
                        <input id="Valor" type="text" name="NLicencia" value="<%=us.getNlicencia()%>"  required>
