...
<%
    Modelos.Automovil Au= (Modelos.Automovil)request.getSession().getAttribute("nombre");
%>
<%
...
<head>
  ...
  <title>Apartar  | Trading Cars</title>
  <!-- Favicons-->
  ...
  <script src="//ajax.googleapis.com/ajax7libs/jquery/1.11.2/jquery.,im.js"></script>
                        ...
                        <div class="row">
                            ...
                            <div class="col col s8 m8 18">
                                <ul id="profile-dropdown" class="dropdown-content">
                                    <li><a href="page-menu-user.jsp"><img src="images/usuarios.png" alt=""> Profile</a>
                                    </li>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                 <h4 style="color: #28B463" > Apartar </h4>
                <br>
                <div class="row">
                    <form class="col s12" method="post" action="ProApartar/nuevo">
                     ...
                     <div class="input-field col s4">
                        ...
                        <div class="input-field col s4">
                            ...
                            <option value="<%=Au.getIdAutomovil()%>"><%=Au.getMarca()%> - <%= Au.getModelo()%> - <%=Au.getKilometraje()%>km</option>
                        </select>
                        <label>Automovil</label>
                      </div>
                        
                        <div class="input-field col s4">
                            <input type="text" value="<%=us.getIdCliente()%>" name="Usuario" style="visibility: hidden;"/>
                      </div>
                        <%}%>
                      <div class="row">
