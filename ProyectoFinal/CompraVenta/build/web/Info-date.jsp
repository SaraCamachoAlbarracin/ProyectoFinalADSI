...
<head>
  ...
  <title>Listado Autos Estancados | Trading Cars</title>
        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
             <h4 style="color: #28B463" > Carros Fuera de Tiempo </h4>
              <br>
              <div class="row">
          ...
          <%
           Session ss = Modelos.HibernateUtil.getSessionFactory().openSession();
            ...
            String hql = "SELECT A FROM Automovil A WHERE A.fechaEntrada >= :minDate AND A.fechaEntrada<= :maxDate";
            List<Modelos.Automovil> result = ss.createQuery(hql).setTimestamp("maxDate", maxDate.getTime())
                                              .setTimestamp("minDate", minDate.getTime()).list();
          for(Modelos.Automovil a:result){
         %>
                    <tbody>
                      <tr>
                      ...
                      <td>   <%=a.getCiudad()%></td>
                      <td>   <%=a.getValor()%></td>
                      <td>   <%=a.getImpuestos()%></td>
                      <td>   <%=a.getEstado()%></td>
                      <td>
                           <a class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
                      </td>
