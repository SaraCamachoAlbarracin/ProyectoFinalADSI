          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463" >Auto/Moto </h4>
              <br>
                <div class="row">
                    <div id="Registro">
                        <form class="col s12" method="post" action="ProAutomovil/create" >
                    ...
                    <div class="input-field col s4">
                     ...
                     <div class="input-field col s4">
                      ...
                      <a class="waves-effect waves-light light-blue btn" onclick="Materialize.toast('I am a toast!', 3000, 'rounded')" style="visibility: hidden;">Round Toast!</a>
