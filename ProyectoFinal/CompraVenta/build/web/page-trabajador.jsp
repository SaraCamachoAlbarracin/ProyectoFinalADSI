...
<head>
  ...
  <title>Trabajador | Trading Cars</title>
...
<!-- END LEFT SIDEBAR NAV-->
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 style="color: #28B463" > Trabajador </h4>
              <br>
                <div class="row">
                    <form class="col s12" method="post" action="ProTrabajador/create">
                   <div class="row">
                    ...
                    <div class="row">
                      <div class="input-field col s4">
                        <input id="first_name" type="text" name="Nombres" required>
                        <label for="first_name">Nombres</label>
                      </div>
                    
                      <div class="input-field col s4">
                        <input id="last_name" type="text" name="Apellidos" required>
                    ...
                    <div class="row">
                      <div class="input-field col s4">
                       ...
                       <div class="input-field col s4">
                        <input id="first_name" type="text" name="Documento" required>
                      ...
                      <div class="row">
                      <div class="input-field col s4">
                        <input id="first_name" type="text" name="Celular" required>
                        <label for="first_name">Celular</label>
                      </div>
                    
                      <div class="input-field col s4">
                        <input id="last_name" type="text" name="Ciudad" required>
 ...
 <div class="input-field col s4">
                        <input id="first_name" type="text" name="Direccion" required>
