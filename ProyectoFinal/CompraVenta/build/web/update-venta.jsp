<%@page import="Modelos.Trabajador"%>
...
<%
    Modelos.Venta a = (Modelos.Venta)request.getSession().getAttribute("nombre");
...
<head>
  ...
  <title>Modificar Venta | Trading Cars</title>
...
<body> 
    ...
    <%
        ...
        Criteria q=ss.createCriteria(Automovil.class);
        List<Automovil> A =q.list();
        
        Criteria qu= ss.createCriteria(Usuario.class);
        List<Usuario> U = qu.list();
        
        Criteria qt = ss.createCriteria(Trabajador.class);
        List<Trabajador> T =qt.list();
    %>
        ...
        <!--breadcrumbs end-->
          ...
          <div class="row">
            <div class="col s12 m12 l12">
                                    ...
                                    <form class="col s12" method="post" action="ProVenta/update">
              <div class="card-panel">
                <h4 style="color: #28B463">Modificar Venta</h4>
                <div class="row">
                        <input value="<%=a.getIdVenta()%>" name="Id" style="visibility: hidden;">
                  
                        <div class="input-field col s4">
                             <input id="Fecha" type="date" name="Fecha" value="<%=a.getFechaEntrega()%>" required>
                        <label for="Fecha"></label>
                      </div>
                        
                     <div class="input-field col s4">
                         <select name="Descuento" id="Descuento" required>
                                 <option value="<%=a.getDescuento()%>"><%=a.getDescuento()%></option>
                     ...
                     <div class="input-field col s4">
                        ...
                        <label>Usuario</label>
                         ...
                         <div class="input-field col s4">
                             <select name="Automovil" id="Automovil" required>
                                 <option value="<%=a.getAutomovil().getIdAutomovil()%>"><%=a.getAutomovil()%></option>
                           <option>Seleccione Otro</option>
                          <% for(Automovil Q:A){%>
                        ...
                        <div class="input-field col s4">
                            <input id="Total" type="text" id="Total" name="Total" value="<%=a.getTotal()%>"  required>
                        <label for="Total"></label>
                      </div>
                        
                        <div class="input-field col s4">
                            <select name="Trabajador" required>
                                 <option value="<%=a.getTrabajador().getIdTrabajador()%>"><%=a.getTrabajador()%></option>
                           <option>Seleccione Otro</option>
                          <% for(Trabajador Q:T){%>
                          <option value="<%=Q.getIdTrabajador()%>"><%=Q.getNombres()%> -- <%=Q.getApellidos()%></option>
                          <%
                           }
                          %>
                        </select>
