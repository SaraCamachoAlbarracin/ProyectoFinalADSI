...
//Contact Page Pop Up
			var popupContactStatus2 = 0;
			
			function loadPopupContact2(){
				if(popupContactStatus2==0){
					$("#popupContact2").fadeIn("slow");
					popupContactStatus2 = 1;
				}
			}
			
			function disablePopupContact2(){
				if(popupContactStatus2==1){
					$("#popupContact2").fadeOut("slow");
					popupContactStatus2 = 0;
				}
			}
			
			function centerPopupContact2(){
				var windowWidth2 = document.documentElement.clientWidth;
				var windowHeight2 = document.documentElement.clientHeight;
				var popupContactHeight2 = $("#popupContact2").height();
				var popupContactWidth2 = $("#popupContact2").width();
				$("#popupContact2").css({
					"position": "absolute",
					"top": windowHeight2/2-popupContactHeight2/2,
					"left": windowWidth2/2-popupContactWidth2/2
				});
			}
			
			
			$(document).ready(function(){
				$("#popupContact2").fadeOut();
				popupContactStatus2 = 0;
				...
				$("#popupContact2").css({
					...
					centerPopupContact2();
					loadPopupContact2();
				    $("#popupContact2").mCustomScrollbar("vertical",400,"easeOutCirc",1.05,"auto","yes","yes",10);						
				});
