        ...
        <div class="container">
          <div class="section">
            ...
            <div id="table-datatables">
              <h4 style="color: #28B463" > Trabajadores Registrados </h4>
              <br>
              <div class="row">
       ...
       %>
                    <tbody>
                      ...
                      <td> 
                               ...
                               <a href="ProTrabajador/read/<%=ñ.getIdTrabajador()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
                               <a href="ProTrabajador/delete/<%=ñ.getIdTrabajador()%>" class="btn-flat waves-effect pink accent-2 white-text"><i class="material-icons">delete</i></a>
