      ...
      <section id="content">
        ...
        <div class="container">
          <div class="section">
            ...
            <h4 style="color: #28B463" >Autos Registrados por: <%=us.getNombres()%> <%=us.getApellidos()%> </h4>
              <br>
              <div class="row">
          ...
          <%
        Query yy = Ss.createQuery("SELECT A from Automovil A INNER JOIN A.usuario WHERE A.usuario='"+us.getIdCliente()+"'");
           List<Modelos.Automovil> o = yy.list();
           for(Modelos.Automovil ñ : o){
         %>
                    <tbody>
                      <tr>
                      <td>  <%=ñ.getFechaEntrada()%></td>
                      <td>   <%=ñ.getTipo()%></td>
                      <td>   <%=ñ.getPlaca()%></td>
                      <td>   <%=ñ.getColor()%></td>
                      <td>  <%=ñ.getModelo()%></td>
                      <td>  <%=ñ.getMarca()%></td>
                      <td>   <%=ñ.getKilometraje()%><label>Km</label></td>
                      <td>   <%=ñ.getCiudad()%></td>
                      <td>   <label>$</label><%
                      Double d = ñ.getValor();
                      out.print(String.valueOf(d.longValue()));
                      %></td>
                      <td>   <%=ñ.getImpuestos()%></td>
                      <td>   <%=ñ.getEstado()%></td>
                      <td> 
     <a href="ProAutomovil/read/<%=ñ.getIdAutomovil()%>" class="btn waves-effect waves-light"><i class="material-icons">edit</i></a>
